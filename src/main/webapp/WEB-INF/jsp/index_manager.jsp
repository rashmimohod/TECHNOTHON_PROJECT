		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="pull-left page-title">Welcome!, ${result.user_type} <p style="padding-left: 7px;color:red;display:inline;font-size:15px"> ${message} </p></h4>
							<div class="pull-right" >
								...
								<!-- <script>
                                 ...
                                 <form action="del_user" method="post" style="display:inline">   
                                  <button  class="btn btn-primary waves-effect waves-light btn-lg m-b-5" id="delete_user"
									>Delete User</button>
                                  </form>
														...
														<div class="form-group ">
															...
															<div class="col-lg-8">
																<form:input path="username" class="form-control"
																	id="firstname" type="text" placeholder="username" required=""/>
														...
														<div class="form-group ">
															...
															<div class="col-lg-8">
																<form:input path="password" class="form-control"
																	id="lastname" type="password" placeholder="password" required=""/>
