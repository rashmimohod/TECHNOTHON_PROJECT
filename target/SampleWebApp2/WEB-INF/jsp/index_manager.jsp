					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="mini-stat clearfix bx-shadow">
								...
								<div class="mini-stat-info text-right text-muted">
									<span class="counter"><%=numofTrainers%></span> External
									Trainers
								</div>
						...
						<div class="col-md-6 col-sm-6 col-lg-3">
							<div class="mini-stat clearfix bx-shadow">
								<form:form modelAttribute="user" id="download" method="get" action="download" novalidate="novalidate">
                                        <button  class="btn btn-primary waves-effect waves-light btn-lg m-b-5"> Download Time Table</button>
                                  </form:form> 
							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<div class="inbox-widget nicescroll mx-box">
										...
										<%@page import="java.util.List"%>
										<%@page import="com.dao.TrainerDao"%>
										<%@page import="com.bean.ExtTrainer"%>
										<%@page import="java.util.Map"%>

										<%
											com.bean.ExtTrainer t1=new ExtTrainer();
																																			
																																		
																																			List<ExtTrainer> ext_trainer_list=new TrainerDao().GetExternalTrainers();
										%>

										<%
											for(ExtTrainer tr:ext_trainer_list){
										%>
