...
<link href="assets/tagsinput/jquery.tagsinput.css" rel="stylesheet" />
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="#" class="waves-effect"><i class="ion ion-person-stalker  "></i><span>Show Batches</span></a>
                                                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="show_trainer_external.html">External</a></li>
 ...
 <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">List Of Batches</h4>
                                    </div>
                                        ...
                                        <div class="inbox-widget nicescroll mx-box1">
                                             ...
                                             <a href="#">
                                                <div class="inbox-item">
                                                    ...
                                                    <p class="inbox-item-author" name="name">Name</p>
                                                    <div class="col-lg-3" name="no_of_cand">number</div>
                                                    <div class="col-lg-3" name="type">type</div>
                                                        <div class="col-lg-3" name="venue">Venue</div>
                                                   <div class="col-lg-2" name="city">city</div>
                                                 </div>
                                            </a>
                                        </div>
                                    </div>
