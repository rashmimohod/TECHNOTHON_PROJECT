            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>TT Generator </span></a>
                    </div>
                </div>
...
post.style.display = 'none';
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="#"><i class="md md-settings-power"></i>Change Password</a></li>
                                       
                                        <li><a href="login.html"><i class="md md-settings-power"></i> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
